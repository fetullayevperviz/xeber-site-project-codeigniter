...
<head>
  ...
  <title>Xəbər Site Admin Giriş Səhifəsi</title>
  <!-- Tell the browser to be responsive to screen width -->
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="shortcut icon" href="<?=base_url('assets/front/');?>images/favicon/favicon2.jpg">
  <!-- Font Awesome -->
...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Admin Giriş Formu</p>
      ...
      <form action="<?= base_url('admin/login');?>" method="post">
        ...
        <div class="input-group mb-3">
          <input type="password" name="password" class="form-control" placeholder="Şifrənizi yazın">
          <div class="input-group-append">
            <div class="input-group-text">
