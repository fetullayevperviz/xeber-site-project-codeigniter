 <!-- Main content -->
    <section class="content">
       <div class="card card-info">
	      ...
	      <form class="form-horizontal" method="POST" action="<?= base_url('admin/category_insert');?>">
	        <div class="card-body">

	          <div class="form-group row">
	            <label class="col-sm-2 col-form-label">Kateqoriya Adı</label>
	            <div class="col-sm-10">
	              <input type="text" name="title" class="form-control" placeholder="kateqoriya adını yazın">
	            </div>
	          </div>
