...
<link rel="stylesheet" href="<?=base_url('assets/front/');?>/css/style_page.css">
...
<!-- pagination css -->
<link rel='stylesheet' href='<?=base_url("assets/front/");?>css/pagination.css' type='text/css' media='all' />
...
<h3 class="title">SON DƏQİQƏ</h3>
</div>
<div class="breaking-news-content">
<ul>
<?php $sd = 0; $sondeqiqe = sondeqiqe($sd); foreach ($sondeqiqe as $son): ?>

<?php if($son['category']=='Siyasət') { ?>
<li><a href="<?php echo base_url('anasehife/siyaset_details/'); echo $son['sef'];?>" title="<?=$son['title'];?>"><?php echo $son['title'];?></a></li>
<?php } elseif($son['category']=='Sosial'){ ?>
<li><a href="<?php echo base_url('anasehife/sosial_details/'); echo $son['sef'];?>" title="<?=$son['title'];?>"><?php echo $son['title'];?></a></li>
<?php } elseif($son['category']=='İqtisadiyyat'){ ?>
<li><a href="<?php echo base_url('anasehife/iqtisadiyyat_details/'); echo $son['sef'];?>" title="<?=$son['title'];?>"><?php echo $son['title'];?></a></li>
<?php } elseif($son['category']=='İdman'){ ?>
<li><a href="<?php echo base_url('anasehife/idman_details/'); echo $son['sef'];?>" title="<?=$son['title'];?>"><?php echo $son['title'];?></a></li>
<?php } elseif($son['category']=='Dünya'){ ?>
<li><a href="<?php echo base_url('anasehife/dunya_details/'); echo $son['sef'];?>" title="<?=$son['title'];?>"><?php echo $son['title'];?></a></li>
<?php } elseif($son['category']=='Cəmiyyət'){ ?>
<li><a href="<?php echo base_url('anasehife/cemiyyet_details/'); echo $son['sef'];?>" title="<?=$son['title'];?>"><?php echo $son['title'];?></a></li>
<?php } ?>	
</li>
<?php endforeach ?>
</ul>
