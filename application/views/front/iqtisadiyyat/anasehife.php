...
<title>İqtisadiyyat Xəbərləri</title>
...
<?php $this->load->view('front/iqtisadiyyat/bredcrumb');?>
<div class="clearfix"></div>
...
<div class="post-title post-title-news">
   <h3>İQTİSADİYYAT XƏBƏRLƏRİ</h3>
</div>
<div class="clearfix"></div>
<div class='all-blogs'>
	<?php $this->load->view('front/iqtisadiyyat/main_content');?>
</div>
</div>
