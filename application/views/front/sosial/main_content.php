...
<a href="<?php echo base_url('anasehife/sosial_details/'); echo $info['sef'];?>" title="<?=$info['title'];?>" rel="bookmark" class='post-img-link'>
<img alt='' width='750' height='354' src='<?php echo base_url(); echo $info['tmb'];?>'>
</a>
</div>
<div class='post-inner-6'>
<h1 class="post-head-title">
<a itemprop="url" href="<?php echo base_url('anasehife/sosial_details/'); echo $info['sef'];?>" title="<?=$info['title'];?>" rel="bookmark">
<?php echo $info['title'];?>
</a>
</h1>
...
<div class="post-more">
	<a class="button-default medium" href="<?php echo base_url('anasehife/sosial_details/'); echo $info['sef'];?>" title="<?=$info['title'];?>" rel="bookmark">
